...
**Total: 8,434 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,328 | 159 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,434** | **165** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,328 | 159 | `-m "unit and not slow"` |
...
| `test_process_single_dataview.py` | 51 | End-to-end single data view processing |
...
| **Total** | **8,434** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,434 tests total)
