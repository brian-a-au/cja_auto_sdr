...
**Total: 7,153 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,047 | 109 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,153** | **115** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,040 | 108 | `-m "unit and not slow"` |
...
| `test_org_writer_compat_contracts.py` | 102 | Org writer compatibility boundary contract tests |
...
| **Total** | **7,153** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,153 tests total)
