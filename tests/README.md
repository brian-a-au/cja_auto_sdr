...
**Total: 7,012 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 6,906 | 109 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,012** | **115** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 6,899 | 108 | `-m "unit and not slow"` |
...
| `test_org_writer_compat_contracts.py` | 86 | Org writer compatibility boundary contract tests |
...
| **Total** | **7,012** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,012 tests total)
