...
**Total: 8,426 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,320 | 159 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,426** | **165** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,320 | 159 | `-m "unit and not slow"` |
...
| **Total** | **8,426** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,426 tests total)
