...
**Total: 8,218 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,112 | 148 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,218** | **154** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,112 | 148 | `-m "unit and not slow"` |
...
| `test_cli_notion_prune.py` | 12 | CLI flag wiring for --notion-prune-orphans |
| **Total** | **8,218** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,218 tests total)
