...
**Total: 8,184 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,078 | 147 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,184** | **153** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,078 | 147 | `-m "unit and not slow"` |
...
| `test_notion_writer.py` | 58 | Notion block builder + API layer tests |
...
| `test_cli_notion_database.py` | 30 | CLI flag wiring for --notion-create-database and --notion-database-id |
| `test_notion_database.py` | 21 | Notion database creation and upsert tests |
| `test_notion_org_publisher.py` | 7 | --org-report --format notion catalog publisher tests |
| `test_notion_registry_v2.py` | 7 | Notion registry v2 schema and legacy v1 migration tests |
| **Total** | **8,184** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,184 tests total)
