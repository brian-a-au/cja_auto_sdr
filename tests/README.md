...
**Total: 8,196 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,090 | 147 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,196** | **153** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,090 | 147 | `-m "unit and not slow"` |
...
| `test_notion_writer.py` | 61 | Notion block builder + API layer tests |
...
| **Total** | **8,196** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,196 tests total)
