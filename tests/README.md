...
**Total: 7,984 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,878 | 137 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,984** | **143** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,878 | 137 | `-m "unit and not slow"` |
...
| `test_watch_prevalidation.py` | 28 | Watch flag semantic prevalidation tests |
...
| **Total** | **7,984** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,984 tests total)
