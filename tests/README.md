...
**Total: 6,926 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 6,820 | 108 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **6,926** | **114** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 6,813 | 107 | `-m "unit and not slow"` |
...
| **Total** | **6,926** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (6,926 tests total)
