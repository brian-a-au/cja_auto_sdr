...
**Total: 8,183 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,077 | 147 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,183** | **153** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,077 | 147 | `-m "unit and not slow"` |
...
| `test_cli_notion_database.py` | 29 | CLI flag wiring for --notion-create-database and --notion-database-id |
...
| **Total** | **8,183** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,183 tests total)
