...
**Total: 8,189 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,083 | 147 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,189** | **153** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,083 | 147 | `-m "unit and not slow"` |
...
| `test_notion_writer.py` | 60 | Notion block builder + API layer tests |
...
| `test_cli_notion_database.py` | 31 | CLI flag wiring for --notion-create-database and --notion-database-id |
...
| **Total** | **8,189** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,189 tests total)
