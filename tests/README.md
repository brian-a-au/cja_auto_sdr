...
**Total: 7,748 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,642 | 123 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,748** | **129** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,635 | 122 | `-m "unit and not slow"` |
...
| `test_json_io.py` | 27 | JSON I/O atomic write and read tests |
...
| **Total** | **7,748** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,748 tests total)
