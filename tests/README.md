...
**Total: 7,758 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,652 | 123 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,758** | **129** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,645 | 122 | `-m "unit and not slow"` |
...
| `test_json_io.py` | 37 | JSON I/O atomic write and read tests |
...
| **Total** | **7,758** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,758 tests total)
