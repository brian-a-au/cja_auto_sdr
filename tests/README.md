...
| `test_org_report.py` | 192 | Org-wide component analysis: config, distribution, similarity, output formats, large org scaling, output path aliases |
...
- [x] Org-wide analysis tests (test_org_report.py) - 192 tests (including large org scaling, output path aliases, memory warnings, smart cache invalidation)
