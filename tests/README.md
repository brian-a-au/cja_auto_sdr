...
**Total: 7,756 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,650 | 123 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,756** | **129** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,643 | 122 | `-m "unit and not slow"` |
...
| **Total** | **7,756** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,756 tests total)
