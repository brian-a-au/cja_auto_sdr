...
**Total: 8,428 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,322 | 159 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,428** | **165** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,322 | 159 | `-m "unit and not slow"` |
...
| **Total** | **8,428** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,428 tests total)
