...
**Total: 7,741 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 7,635 | 123 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,741** | **129** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 7,628 | 122 | `-m "unit and not slow"` |
...
| `test_json_io.py` | 21 | JSON I/O atomic write and read tests |
...
| **Total** | **7,741** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,741 tests total)
