...
**Total: 7,009 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 6,903 | 109 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **7,009** | **115** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 6,896 | 108 | `-m "unit and not slow"` |
...
| `test_org_writer_compat_contracts.py` | 83 | Org writer compatibility boundary contract tests |
...
| **Total** | **7,009** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (7,009 tests total)
