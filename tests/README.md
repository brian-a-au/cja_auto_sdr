...
**Total: 8,435 comprehensive tests**
...
|----------|-------|-------|-------|
| `unit` | 8,329 | 159 | Default primary category for files without explicit integration/e2e/smoke scope |
...
| **Primary Total** | **8,435** | **165** | **unit + integration + e2e + smoke** |

| CI Slice | Tests | Files | Selector |
|----------|-------|-------|----------|
| `test-unit` | 8,329 | 159 | `-m "unit and not slow"` |
...
| `test_validation_cache.py` | 32 | Validation result caching |
| `test_process_single_dataview.py` | 52 | End-to-end single data view processing |
...
| `test_snapshot.py` | 85 | Diff snapshot creation and comparison |
...
| **Total** | **8,435** | **Collected via pytest --collect-only** |
...
- [x] Comprehensive test coverage (8,435 tests total)
