...
<body>
    <div class="header">
        ...
        <p style="margin: 10px 0 0 0; opacity: 0.9;">Generated with v3.0.10</p>
    </div>
...
"""
    ...
    <div class="footer">
        <p>Generated by CJA Auto SDR Generator v3.0.10</p>
...
def main():
    print("=" * 70)
    print("  Creating Sample Output Files - v3.0.10")
    print("=" * 70)
